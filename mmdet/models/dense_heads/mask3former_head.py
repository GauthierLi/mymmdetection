...
from .maskformer3_head import MaskFormerHead3
...
class Mask3FormerHead(MaskFormerHead3):
    ...
    def loss_single(self, cls_scores, mask_preds, gt_labels_list,
        ...
        if mask_targets.shape[0] == 0:
            ...
            gau_loss = mask_preds.sum()
            if self.proj_loss_enabled:
                loss_proj = mask_preds.sum()
            else:
                loss_proj = None
            return loss_cls, loss_mask, loss_dice, loss_proj, gau_loss
        ...
        if self.gau_dice_enabled:
            ...
            gau_loss = self.loss_gau_dice(mask_pred_rescale, mask_targets)
        # mask loss
